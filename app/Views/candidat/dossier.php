      ...
      <tr>
        ...
        <td>
          <?php if ($dossier['statut'] === 'BROUILLON'): ?>
            <form method="post" action="/candidat/upload" enctype="multipart/form-data" style="display:flex;gap:8px;align-items:center">
...
<?php if ($dossier['statut'] === 'BROUILLON'): ?>
  <form method="post" action="/candidat/soumettre" style="margin-top:12px;">
    <input type="hidden" name="csrf_token" value="<?= htmlspecialchars($csrf) ?>">
